...
const _elevationTexts = (document.getElementById("elevation-text") as GraphicsElement).getElementsByTagName("image") as ImageElement[];
...
simpleMinutes.initialize("user", (clock) => {
  ...
  if (clock.Minutes) {
    ...
    if (clock.HoursAngle !== undefined && _hoursTick.groupTransform !== undefined) _hoursTick.groupTransform.rotate.angle = clock.HoursAngle;
    if (clock.MinutesAngle !== undefined && _minutesTick.groupTransform !== undefined) _minutesTick.groupTransform.rotate.angle = clock.MinutesAngle;
  }
  if (_secondsTick.groupTransform !== undefined && clock.SecondsAngle !== undefined) _secondsTick.groupTransform.rotate.angle = clock.SecondsAngle;
...
simpleWeather.initialize((weather) => {
  ...
  image.href = `images/weather/${weather.conditionCode}.png`;
